...
import { Car, Gauge, Wrench, History, LogOut, Menu } from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden min-w-0">
                <header className="h-16 bg-white shadow-sm flex items-center justify-between px-6 z-10 shrink-0">
                    ...
                    <div className="flex items-center space-x-3 ml-auto">
                        ...
                        <div className="w-8 h-8 bg-teal-500 text-white rounded-full flex items-center justify-center font-bold text-sm">{initial}</div>
                    </div>
                </header>
